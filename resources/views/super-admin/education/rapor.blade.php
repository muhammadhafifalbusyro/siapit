...
<body>
        ...
        <main class="main-content">
            ...
            <header class="main-header">
                <div class="welcome-section">
                    <h1>Rapor Hasil Pendidikan</h1>
                    <p>Pantau rekapitulasi penilaian per kelas dan tentukan hasil seleksi akhir santri pendidikan.</p>
                </div>
            </header>
            ...
            <div class="dashboard-panel" style="width: 100%; margin-bottom: 1.5rem; padding: 1.25rem 1.5rem;">
                <form method="GET" action="{{ route('super-admin.education.rapor') }}" style="display: flex; flex-wrap: wrap; gap: 1.5rem; align-items: flex-end;">
            ...
            @if(!$activePeriod)
                <div class="dashboard-panel" style="width: 100%; text-align: center; padding: 4rem 2rem; color: var(--text-secondary);">
                    Belum ada konfigurasi pendidikan aktif untuk periode yang dipilih.
                </div>
            @elseif($classrooms->count() == 0)
                <div class="dashboard-panel" style="width: 100%; text-align: center; padding: 4rem 2rem; color: var(--text-secondary);">
                    Belum ada kelas yang terdaftar pada periode pendidikan ini.
                </div>
            @else
                @php
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" style="text-align: center; padding: 2.5rem; color: var(--text-secondary); font-weight: 600;">Belum ada peserta pendidikan aktif untuk kelas ini.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
    ...
    <script>
        ...
        function saveDecision(select) {
            ...
            fetch("{{ route('super-admin.education.rapor.process') }}", {
                method: 'POST',
                body: formData,
                headers: {
            ...
            pagesHtml += `
                <div class="print-page">
                    <div class="rapor-header">
                        <div>
                            <h2 class="rapor-title" style="font-size: 1.6rem; letter-spacing: -0.5px;">RAPOR HASIL MASA PENDIDIKAN</h2>
