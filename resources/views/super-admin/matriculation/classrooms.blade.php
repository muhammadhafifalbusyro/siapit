...
<body>
        ...
        <main class="main-content">
            ...
            <header class="main-header">
                <div class="welcome-section">
                    <h1>Pembagian Kelas & Peserta Matrikulasi</h1>
                    <p>Kelompokkan calon santri ke dalam grup bimbingan matrikulasi beserta penetapan wali kelas.</p>
                </div>
            </header>
            ...
            <div class="dashboard-panel" style="width: 100%; margin-bottom: 1.5rem; padding: 1.25rem 1.5rem;">
                <form method="GET" action="{{ route('super-admin.matriculation.classrooms') }}" style="display: flex; flex-wrap: wrap; gap: 1.5rem; align-items: flex-end;">
            ...
            @if(!$activePeriod)
                <div class="dashboard-panel" style="width: 100%; text-align: center; padding: 4rem 2rem;">
                    ...
                    <h2 style="font-family: var(--font-heading); font-size: 1.4rem; font-weight: 800; color: var(--text-primary); margin-bottom: 0.5rem;">Masa Matrikulasi Belum Dikonfigurasi</h2>
                    ...
                    <a href="{{ route('super-admin.matriculation.settings') }}" style="text-decoration: none; display: inline-flex; align-items: center; justify-content: center; background: var(--bg-primary); box-shadow: var(--nm-flat-sm); color: var(--accent-blue); padding: 0.75rem 2rem; border-radius: 10px; font-weight: 800; font-size: 0.9rem; transition: var(--transition);" onmouseover="this.style.boxShadow='var(--nm-flat-hover)'" onmouseout="this.style.boxShadow='var(--nm-flat-sm)'">
                            ...
                            <div class="card-nm" style="padding: 1.5rem; display: flex; flex-direction: column; gap: 1.25rem;">
                                <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1.5px solid #d1d9e6; padding-bottom: 0.75rem;">
                                    ...
                                    <div style="display: flex; gap: 0.5rem;">
                                        ...
                                        <button onclick="openAssignSkillModal({{ $cls->id }}, '{{ $cls->matriculation_skill_id }}')" style="border: none; background: var(--bg-primary); box-shadow: var(--nm-flat-sm); padding: 0 0.75rem; height: 32px; border-radius: 8px; font-weight: 800; font-size: 0.75rem; color: var(--accent-green, #10b981); cursor: pointer; display: flex; align-items: center; gap: 0.25rem;" onmouseover="this.style.boxShadow='var(--nm-flat-hover)'" onmouseout="this.style.boxShadow='var(--nm-flat-sm)'" title="Pilih Skill">
                                ...
                                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 1rem; font-size: 0.85rem;">
                                    ...
                                    <div style="display: flex; flex-direction: column; gap: 0.25rem;">
                                        ...
                                        <span style="font-weight: 800; color: var(--accent-green, #10b981);">{{ $cls->matriculationSkill->name ?? '-' }}</span>
                                    </div>
                                </div>
                            </div>
                        @empty
                        ...
                        <div class="dashboard-panel" style="max-height: 500px; overflow-y: auto; padding: 1.25rem; display: flex; flex-direction: column; gap: 1rem;">
                            @forelse($unassignedStudents as $us)
                                <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.85rem 1rem; background: var(--bg-primary); box-shadow: var(--nm-flat-sm); border-radius: 10px;">
                                    ...
                                    <form method="POST" action="{{ route('super-admin.matriculation.classrooms.assign-students') }}" style="margin: 0;">
                                        @csrf
    ...
    <div id="students-modal-overlay" style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: rgba(0,0,0,0.15); backdrop-filter: blur(4px); z-index: 1000; display: none; align-items: center; justify-content: center; padding: 1.5rem;">
        <div class="card-nm" style="width: 100%; max-width: 500px; padding: 2rem; position: relative; max-height: 90vh; display: flex; flex-direction: column;">
            ...
            <!-- Choose Leader Form -->
            <form id="choose-leader-form" method="POST" action="{{ route('super-admin.matriculation.classrooms.set-leader') }}" style="border-top: 1.5px solid #d1d9e6; padding-top: 1rem; display: flex; flex-direction: column; gap: 0.75rem;">
                @csrf
    ...
    <script>
        ...
        function openClassroomStudentsModal(classId, className, students, leaderRegId) {
            ...
            students.forEach(student => {
                ...
                const removeActionHtml = student.status === 'passed' 
                    ...
                    : `<form method="POST" action="/super-admin/matriculation/classrooms/remove-student/${student.id}" style="margin: 0;" onsubmit="return confirm('Keluarkan santri ini dari kelas?')">
        ...
        function openAssignSkillModal(classId, selectedSkillId) {
            ...
            if (assignSkillForm) assignSkillForm.action = `/super-admin/matriculation/classrooms/${classId}/assign-skill`;
        ...
        <div class="card-nm" style="width: 100%; max-width: 480px; padding: 2rem; position: relative;">
            ...
            <form id="assign-skill-form" method="POST" style="display: flex; flex-direction: column; gap: 1.25rem; text-align: left;">
                ...
                <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                    ...
                    <div class="select-wrapper">
                        <select name="matriculation_skill_id" id="skill-select" style="width: 100%; border: none; background: transparent; outline: none; font-weight: 600; color: var(--text-primary); padding: 0 1rem; height: 100%;">
