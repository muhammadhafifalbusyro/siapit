    ...
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
            ...
            <div class="dashboard-panel" style="width: 100%; margin-bottom: 1.5rem; padding: 1.25rem 1.5rem;">
                <form method="GET" action="{{ route('super-admin.matriculation.daily-control') }}" style="display: flex; flex-wrap: wrap; gap: 1.5rem; align-items: flex-end;">
            ...
            @if(!$activePeriod || $classrooms->count() == 0 || !$selectedAspect)
                <div class="dashboard-panel" style="width: 100%; text-align: center; padding: 4rem 2rem; color: var(--text-secondary);">
                    Belum ada kelas, aspek penilaian, atau konfigurasi matrikulasi aktif untuk periode yang dipilih.
                </div>
            @else
                @php
                ...
                <div class="dashboard-panel" style="width: 100%;">
                    <form id="daily-control-form" method="POST" action="{{ route('super-admin.matriculation.daily-control.store') }}">
                        @csrf
