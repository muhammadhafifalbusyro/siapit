...
<head>
    ...
    <title>Rapor Kelas Matrikulasi - SIAPIT</title>
...
<body>
            ...
            <header class="main-header">
                <div class="welcome-section" style="display: flex; align-items: center; justify-content: space-between; width: 100%; flex-wrap: wrap; gap: 1rem;">
                    <div style="display: flex; align-items: center; gap: 1rem;">
                        <a href="{{ route('pengajar.matriculation.rapor.list') }}" style="border: none; background: var(--bg-primary); box-shadow: var(--nm-flat-sm); width: 38px; height: 38px; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: var(--text-primary); transition: var(--transition); text-decoration: none;" onmouseover="this.style.boxShadow='var(--nm-flat-hover)'" onmouseout="this.style.boxShadow='var(--nm-flat-sm)'">
                            <i class="fa-solid fa-arrow-left"></i>
                        </a>
                        <div>
                            <h1>Rapor Kelas Matrikulasi: {{ $classroom->name }}</h1>
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" style="text-align: center; padding: 2rem; color: var(--text-secondary);">Kelas Anda belum memiliki anggota bimbingan.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
    ...
    <script>
        ...
        function saveDecision(select) {
            ...
            fetch("{{ route('pengajar.matriculation.rapor.process') }}", {
                method: 'POST',
                body: formData,
                headers: {
