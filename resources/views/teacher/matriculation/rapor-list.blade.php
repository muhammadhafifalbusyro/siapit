    ...
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
            ...
            <header class="main-header">
                <h1>Rapor Matrikulasi</h1>
                <p>Pilih kelas bimbingan Anda untuk memantau capaian rapor dan kelulusan santri.</p>
            </header>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 1.5rem; margin-top: 1.5rem;">
                    @forelse($classrooms as $cls)
                        <div style="background: var(--bg-primary); box-shadow: var(--nm-flat-sm); border-radius: 20px; padding: 1.5rem; border: 1.5px solid rgba(255,255,255,0.4); display: flex; flex-direction: column; justify-content: space-between;">
                            ...
                            <div style="margin-top: 1.5rem;">
                                <a href="{{ route('pengajar.matriculation.rapor.show', $cls->id) }}" style="text-decoration: none; display: flex; align-items: center; justify-content: center; height: 38px; border-radius: 10px; background: var(--bg-primary); box-shadow: var(--nm-flat-sm); color: var(--accent-blue); font-weight: 800; font-size: 0.85rem; width: 100%; transition: var(--transition); gap: 0.35rem;" onmouseover="this.style.boxShadow='var(--nm-flat-hover)'" onmouseout="this.style.boxShadow='var(--nm-flat-sm)'" onmousedown="this.style.boxShadow='var(--nm-inset-sm)'" onmouseup="this.style.boxShadow='var(--nm-flat-hover)'">
                    ...
                    @empty
                        <div style="grid-column: 1 / -1; text-align: center; color: var(--text-secondary); padding: 3rem 1rem;">
                            ...
                            Anda belum ditugaskan di kelas matrikulasi mana pun.
                        </div>
                    @endforelse
                </div>
            </div>
