...
<head>
    ...
    <title>Kontrol Harian Matrikulasi - SIAPIT</title>
    ...
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
            ...
            <header class="main-header">
                <h1>Kontrol Harian Matrikulasi</h1>
                <p>Pilih kelas yang Anda bimbing untuk mengelola capaian kontrol harian santri.</p>
            </header>

            <div class="dashboard-panel">
                <h3 class="panel-title"><i class="fa-solid fa-school"></i> Daftar Kelas Asuhan Matrikulasi</h3>
                    ...
                    @forelse($classrooms as $cls)
                        <div style="background: var(--bg-primary); box-shadow: var(--nm-flat-sm); border-radius: 20px; padding: 1.5rem; border: 1.5px solid rgba(255,255,255,0.4); display: flex; flex-direction: column; justify-content: space-between;">
                            ...
                            <div style="margin-top: 1.5rem;">
                                <a href="{{ route('pengajar.daily-control', $cls->id) }}" style="text-decoration: none; display: flex; align-items: center; justify-content: center; height: 38px; border-radius: 10px; background: var(--bg-primary); box-shadow: var(--nm-flat-sm); color: var(--accent-blue); font-weight: 800; font-size: 0.85rem; width: 100%; transition: var(--transition); gap: 0.35rem;" onmouseover="this.style.boxShadow='var(--nm-flat-hover)'" onmouseout="this.style.boxShadow='var(--nm-flat-sm)'" onmousedown="this.style.boxShadow='var(--nm-inset-sm)'" onmouseup="this.style.boxShadow='var(--nm-flat-hover)'">
