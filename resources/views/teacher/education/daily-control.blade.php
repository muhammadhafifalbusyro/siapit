        ...
        <main class="main-content">
            ...
            <header class="main-header">
                <div class="welcome-section" style="display: flex; align-items: center; gap: 1rem; width: 100%;">
                    <a href="{{ route('pengajar.education.daily-control.list') }}" style="border: none; background: var(--bg-primary); box-shadow: var(--nm-flat-sm); width: 38px; height: 38px; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: var(--text-primary); transition: var(--transition); text-decoration: none;" onmouseover="this.style.boxShadow='var(--nm-flat-hover)'" onmouseout="this.style.boxShadow='var(--nm-flat-sm)'">
            ...
            <div class="dashboard-panel" style="width: 100%; margin-bottom: 1.5rem; padding: 1.25rem 1.5rem;">
                <form method="GET" action="{{ route('pengajar.education.daily-control', $classroom->id) }}" style="display: flex; flex-wrap: wrap; gap: 1.5rem; align-items: flex-end;">
            ...
            @else
                ...
                <div class="dashboard-panel" style="width: 100%;">
                    <form id="daily-control-form" method="POST" action="{{ route('pengajar.education.daily-control.store') }}">
                        @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function recalculateGrid() {
                const selectTypeEl = document.querySelector('select[name="input_type"]');
                const selectedType = selectTypeEl ? selectTypeEl.value : document.querySelector('input[name="input_type"]')?.value;
