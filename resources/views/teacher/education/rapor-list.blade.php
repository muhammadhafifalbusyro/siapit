...
<head>
    ...
    <title>Rapor Pendidikan - SIAPIT</title>
    ...
    <div class="dashboard-wrapper">
        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-footer">
                <div class="user-profile-sm">
                    <div class="avatar-sm{{ strtoupper(substr($user->name, 0, 2)) }}">U</div>
        ...
        <main class="main-content">
            ...
            <header class="main-header">
                <h1>Rapor Masa Pendidikan</h1>
                <p>Pilih kelas bimbingan Anda untuk memantau capaian rapor dan kelulusan santri selama Masa Pendidikan.</p>
            </header>

            <div class="dashboard-panel">
                <h3 class="panel-title"><i class="fa-solid fa-file-invoice"></i> Daftar Rapor Kelas Asuhan</h3>
                    ...
                    @forelse($classrooms as $cls)
                        <div style="background: var(--bg-primary); box-shadow: var(--nm-flat-sm); border-radius: 20px; padding: 1.5rem; border: 1.5px solid rgba(255,255,255,0.4); display: flex; flex-direction: column; justify-content: space-between;">
                            ...
                            <div style="margin-top: 1.5rem;">
                                <a href="{{ route('pengajar.education.rapor.show', $cls->id) }}" style="text-decoration: none; display: flex; align-items: center; justify-content: center; height: 38px; border-radius: 10px; background: var(--bg-primary); box-shadow: var(--nm-flat-sm); color: var(--accent-blue); font-weight: 800; font-size: 0.85rem; width: 100%; transition: var(--transition); gap: 0.35rem;" onmouseover="this.style.boxShadow='var(--nm-flat-hover)'" onmouseout="this.style.boxShadow='var(--nm-flat-sm)'" onmousedown="this.style.boxShadow='var(--nm-inset-sm)'" onmouseup="this.style.boxShadow='var(--nm-flat-hover)'">
                                    <i class="fa-solid fa-eye"></i> Lihat Rapor Kelas
                                </a>
                            </div>
                        </div>
                    @empty
