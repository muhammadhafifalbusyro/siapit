...
<head>
    ...
    <title>Rapor Matrikulasi Saya - SIAPIT</title>
        ...
        <main class="main-content">
            <header class="main-header">
                <div class="welcome-section">
                    <h1>Rapor Saya Matrikulasi</h1>
                    <p>Tinjauan akumulasi realisasi pencapaian target bulanan dan nilai gabungan Anda.</p>
                </div>
            </header>

            @if($matriculationStudent && $activePeriod)
                <div class="dashboard-panel">
                    <h2 class="panel-title"><i class="fa-solid fa-file-invoice"></i> Rapor Kumulatif Matrikulasi</h2>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 2rem;">
                        <div style="background: var(--bg-primary); box-shadow: var(--nm-inset-sm); padding: 1.5rem; border-radius: 12px; text-align: center;">
                            ...
                            <div style="font-size: 1.25rem; font-weight: 900; margin-top: 0.5rem; color: {{ $matriculationStudent->status === 'passed' ? '#10b981' : '#f59e0b' }};">
                                {{ $matriculationStudent->status === 'passed' ? 'LULUS MATRIKULASI' : 'AKTIF / PROSES SELEKSI' }}
                            </div>
                        </div>
                        <div style="background: var(--bg-primary); box-shadow: var(--nm-inset-sm); padding: 1.5rem; border-radius: 12px; text-align: center;">
