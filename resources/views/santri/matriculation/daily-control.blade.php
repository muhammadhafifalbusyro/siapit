        ...
        <main class="main-content">
            <header class="main-header">
                <div class="welcome-section">
                    <h1>Kontrol Nilai Harian Matrikulasi</h1>
            ...
            <div class="dashboard-panel" style="width: 100%; margin-bottom: 1.5rem; padding: 1.25rem 1.5rem;">
                <form method="GET" action="{{ route('santri.matriculation.daily-control') }}" style="display: flex; gap: 1.5rem; align-items: flex-end;">
            ...
            @if(!$activePeriod || !$selectedAspect)
                <div class="dashboard-panel" style="width: 100%; text-align: center; padding: 4rem 2rem; color: var(--text-secondary);">
                    Belum ada masa matrikulasi aktif atau aspek penilaian untuk periode ini.
                </div>
            @else
                @php
                    $weeks = [];
                ...
                <div class="dashboard-panel" style="width: 100%;">
                    ...
                    <span style="font-size: 0.8rem; font-weight: 700; color: var(--text-secondary); margin-bottom: 1.5rem; display: block;">
